...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['allow_empty']  = array('Leeren Wert erlauben', 'Anwählen, falls dieser Filterwert leer sein darf. Falls ausgewählt verhält sich die Filterregel in diesem Fall als ob sie nicht definiert ist.');
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['stop_after_match']  = array('Nach erstem Treffen stoppen', 'Anwählen falls die Ausführung der Filteregel nach dem ersten Treffer angehalten werden soll.');
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['urlparam']     = array('URL-Parameter', 'Den URL-Parameter angeben, der für das ausgewählte Attribut benutzt werden soll. Der <em>"auto_item"</em> kann ebenfalls benutzt werden und ist nützlich für Alias-Spalten.');
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['predef_param'] = array('Statischer Parameter', 'Anwählen falls ein Parameter aus einem Parent-Element benutzt werden soll (Modul, Contentelement, etc.).');
